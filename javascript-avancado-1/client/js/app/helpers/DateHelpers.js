class DateHelper{
  ...
  static textoParaData(texto){
    ...
    return new Date(...texto.split('-').map((item, indice) => item - indice % 2)); //.map é um metodo que percorre
    //cada item do array velho, transforma, e cria novo array - ver Read.me no github.
