class NegociacaoController {
  ...
  adiciona(event){
    ...
    let data = new Date(... //esses 3 pontinhos são novos do ECMAScript6. É um operador chamado spread operation, que desmembra o array passado para os parâmetros do Date, ou seja, array[0] é o primeiro parâmentro, array[1] é o segundo parâmetro, e assim por diante.
